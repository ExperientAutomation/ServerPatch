...
//        			InternetAddress.parse("mahesh.mishra@experient-inc.com,sreejak@infinite.com,Chandrasekar.kulandasamy@infinite.com,sandy.young@experient-inc.com,katie.brewster@experient-inc.com"));
        ...
        message.setRecipients(Message.RecipientType.TO,
    			InternetAddress.parse("sreejak@infinite.com,Chandrasekhar.Kulandasamy@experient-inc.com,Sirasanambati.Anudeep@infinite.com"));
...
//        message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("Chandrasekar.kulandasamy@infinite.com"));
        ...
        if (spt.testType.equalsIgnoreCase("Pre-Test")) message.setSubject("Automation Report for Lead Server Patch Pre-Test");
        if (spt.testType.equalsIgnoreCase("Post-Test")) message.setSubject("Automation Report for Lead Server Patch Post-Test");
